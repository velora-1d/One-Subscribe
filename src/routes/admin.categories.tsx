    ...
    <div className="space-y-8 font-sans text-left">
      ...
      <section className="bg-white border border-slate-200 rounded-xl overflow-hidden flex flex-col shadow-sm">
        <div className="px-6 py-5 border-b border-slate-200 flex justify-between items-center bg-slate-50">
          <h2 className="text-base font-bold text-slate-900 font-display">Semua Kategori</h2>
            ...
            <table className="w-full text-left border-collapse whitespace-nowrap">
              <thead>
                <tr className="bg-slate-50/70 text-[10px] text-slate-400 font-bold uppercase tracking-wider border-b border-slate-200">
                  <th className="px-6 py-4 border-b border-slate-200">Nama Kategori</th>
                  <th className="px-6 py-4 border-b border-slate-200">Deskripsi</th>
                  <th className="px-6 py-4 border-b border-slate-200">Tanggal Dibuat</th>
                  <th className="px-6 py-4 border-b border-slate-200 text-right pr-12">Aksi</th>
                </tr>
              </thead>
                      ...
                      <td className="px-6 py-4 text-right pr-12">
                        <div className="flex justify-end gap-2">
                          ...
                          <button
                            ...
                            className="bg-red-55/50 hover:bg-red-100/70 text-red-600 border border-red-200 px-3 py-1.5 rounded-lg text-xs font-bold transition-all cursor-pointer flex items-center gap-1 font-sans"
                          >
