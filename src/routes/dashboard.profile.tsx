  ...
  return (
    <div className="space-y-8 font-sans text-left">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {/* Profile Info Form */}
        <div className="island-shell border border-[var(--line)] rounded-3xl p-6">
          ...
          <form onSubmit={handleUpdateProfile} className="space-y-4">
            ...
            <button
              ...
              className="w-full rounded-xl bg-slate-900 hover:bg-slate-800 py-3 text-xs font-bold text-white shadow-sm hover:scale-95 transition-all disabled:opacity-50 cursor-pointer border-0"
            >
